...
var queryCount = async function (queryArgs, res) {
	...
	try{    
		...
		var sqlQueryStmt = 'select count(*) from ' + process.env.MYSQL_TABLE + ' where MyTime >  \'' +  queryArgs.STime  + '\' and MyTime < \'' +  queryArgs.ETime + '\' group by \'' + queryArgs.No + '\';';
